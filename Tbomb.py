#########################################
# JawStar
# A Indian SMS Bomber Tool
# Author: JawStar Inc.
# GitHub: https://github.com/JawStar
# Version: 4.1.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/JawStar/ToxicBomber/main/more/.version").json()
    except:
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : JawStar Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/JawStar \033[94m│".center(columns+9))
